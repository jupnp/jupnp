...
import org.jupnp.transport.impl.servlet.jakarta.ServletStreamServerConfigurationImpl;
import org.jupnp.transport.impl.servlet.jakarta.ServletStreamServerImpl;
 ...
 * {@code org.jupnp.transport.httpservice}'s {@code HttpServiceSharedStreamServerProvider}, which bridges to
 ...
 * </p>
 * <p>
 * This bundle and {@code org.jupnp.transport.httpservice} can both be installed at once without conflict: at
