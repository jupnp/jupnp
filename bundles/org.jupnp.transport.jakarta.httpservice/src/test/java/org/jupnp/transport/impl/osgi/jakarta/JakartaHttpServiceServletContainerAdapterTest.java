 ...
 * both interfaces are large, but {@link JakartaHttpServiceServletContainerAdapter#addConnector(String, int)}
 ...
 */
class JakartaHttpServiceServletContainerAdapterTest {
    ...
    void addConnectorWaitsForEndpointToBecomeAvailable() throws Exception {
        ...
        BundleContext context = fakeBundleContext(() -> System.currentTimeMillis() - testStart >= availableAfterMillis
                ...
                : null);
        JakartaHttpServiceServletContainerAdapter adapter = new JakartaHttpServiceServletContainerAdapter(context);
    ...
    private static <T> T proxy(Class<T> type, InvocationHandler delegate) {
        ...
        return (T) Proxy.newProxyInstance(JakartaHttpServiceServletContainerAdapterTest.class.getClassLoader(),
