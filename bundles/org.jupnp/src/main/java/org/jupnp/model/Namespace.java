 ...
 * }</pre>
 * <p>
 * The namespace is also used to discover and create all {@link org.jupnp.model.resource.Resource}s
 * given a {@link org.jupnp.model.meta.Device}'s metadata. This procedure is typically
 * invoked once, when the device is added to the {@link org.jupnp.registry.Registry}.
 * </p>
 *
