 ...
 * this manager, available with {@link org.jupnp.model.meta.LocalService#getManager()}:
 * </p>
 * <ul>
 * <li>
 * The {@link org.jupnp.model.action.ActionExecutor}s use the manager to process
 ...
 * that satisfies the requirements. The {@link org.jupnp.model.action.ActionExecutor}
 * works together with the manager, for example, the
 * {@link org.jupnp.model.action.MethodActionExecutor} expects that an action
 ...
 * the {@link org.jupnp.model.DefaultServiceManager}. A different service manager
 * might require a different set of action executors, and vice versa.
 * </li>
 * <li>
 * The {@link org.jupnp.model.state.StateVariableAccessor}s use the manager
 ...
 * {@link org.jupnp.model.state.StateVariableAccessor} works together with
 * the service manager, for example, the {@link org.jupnp.model.state.FieldStateVariableAccessor}
 ...
 * {@link org.jupnp.model.DefaultServiceManager}. A different service manager
...
public interface ServiceManager<T> {
     ...
     * <p>
     * The service manager will execute the given {@link org.jupnp.model.Command} and it
     ...
     *
     * @return A <code>Collection</code> of {@link org.jupnp.model.state.StateVariableValue}, representing
