 ...
 * </p>
 * <p>
 * This is the {@code jakarta.servlet} counterpart of
 * {@code org.jupnp.transport.impl.servlet.ServletContainerAdapter} -- the two namespaces are
...
public interface ServletContainerAdapter {
     ...
     * make sure the container won't shut it down when {@link #stopIfRunning()} is called!
     *
