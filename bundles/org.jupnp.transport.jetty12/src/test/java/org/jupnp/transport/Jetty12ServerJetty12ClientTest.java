 ...
 */
class Jetty12ServerJetty12ClientTest extends StreamServerClientTest {

    private static final TransportConfiguration jettyTransportConfiguration = Jetty12TransportConfiguration.INSTANCE;
    private static final StreamClientConfiguration sccConfiguration = new StreamClientConfigurationImpl(null, 3, 0, 0,
            0);

    @BeforeAll
    static void start() throws Exception {
        start(Jetty12ServerJetty12ClientTest::createStreamServer, Jetty12ServerJetty12ClientTest::createStreamClient);
    }
