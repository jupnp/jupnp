 ...
 */
package org.jupnp.transport.jetty9;
...
public class Jetty9TransportConfiguration implements TransportConfiguration {

    public static final TransportConfiguration INSTANCE = new Jetty9TransportConfiguration();
    ...
    public StreamClient createStreamClient(final ExecutorService executorService,
        ...
        Jetty9StreamClientConfigurationImpl clientConfiguration = new Jetty9StreamClientConfigurationImpl(
                executorService, configuration.getTimeoutSeconds(), configuration.getLogWarningSeconds(),
                configuration.getRetryAfterSeconds(), configuration.getRetryIterations());

        return new Jetty9StreamClientImpl(clientConfiguration);
    }

    @Override
    public StreamServer createStreamServer(final int listenerPort) {
        return new ServletStreamServerImpl(
                new ServletStreamServerConfigurationImpl(Jetty9ServletContainer.INSTANCE, listenerPort));
    }
}
