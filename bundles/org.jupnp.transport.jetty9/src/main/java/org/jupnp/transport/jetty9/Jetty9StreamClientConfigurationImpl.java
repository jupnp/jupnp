 ...
 */
public class Jetty9StreamClientConfigurationImpl extends org.jupnp.transport.impl.StreamClientConfigurationImpl {

    public Jetty9StreamClientConfigurationImpl(ExecutorService timeoutExecutorService) {
        super(timeoutExecutorService);
    }

    public Jetty9StreamClientConfigurationImpl(ExecutorService timeoutExecutorService, int timeoutSeconds) {
