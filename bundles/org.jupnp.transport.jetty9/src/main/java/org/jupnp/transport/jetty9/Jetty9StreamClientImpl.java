 ...
 */
public class Jetty9StreamClientImpl extends AbstractStreamClient<Jetty9StreamClientConfigurationImpl, Request> {

    private final Logger logger = LoggerFactory.getLogger(StreamClient.class);

    protected final Jetty9StreamClientConfigurationImpl configuration;
    protected final HttpClient httpClient;
    protected final HttpFields defaultHttpFields = new HttpFields();

    public Jetty9StreamClientImpl(Jetty9StreamClientConfigurationImpl configuration) throws InitializationException {
    ...
    @Override
    public Jetty9StreamClientConfigurationImpl getConfiguration() {
